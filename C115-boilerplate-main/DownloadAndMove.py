...
from_dir = "/Users/aryavkhurana/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "/Users/aryavkhurana/Desktop/Downloaded_Files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
